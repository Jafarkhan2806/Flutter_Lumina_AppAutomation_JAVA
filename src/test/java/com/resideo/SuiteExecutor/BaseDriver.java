...
public  class BaseDriver  {
	...
	public AppiumDriver<MobileElement> setUp() throws Exception {
				...
				.getConstantValue(SuiteConstantTypes.TEST_SUITE, "Requirment_File_Name").contains("Android")) 
		{
			...
			capabilities.setCapability("app", "/Users/e844455/Documents/LANTERN_APP/LUMINA_APP/Android/Debug_1502.apk");
			...
			capabilities.setCapability("noReset", true);
			capabilities.setCapability("app", "/Users/e844455/Documents/LANTERN_APP/LUMINA_APP/iOS/Debug.app");
			capabilities.setCapability("automationName", "Flutter");
			capabilities.setCapability("newCommandTimeout", "36000");
