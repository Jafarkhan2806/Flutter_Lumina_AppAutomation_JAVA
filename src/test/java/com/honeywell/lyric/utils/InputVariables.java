...
public class InputVariables {
	...
	public static String ADD_PERIODNAME = "addPeriodname";
	...
	public static final char degreeIOS = (char) c;
	
	public static final int  dot= 46;
	public static final char DOT = (char) dot;
	...
	public static int SET_RADIUS = 0;
	public static int SET_RADIUS_LOCATION2 = 0;
	public static int CHANGE_RADIUS = 0;
	public static int CHANGE_RADIUS_LOCATION2 = 0;
	
	public static final Double Latitude_Loca = 19.2764380 ;
	public static final Double Longitude_Loca = 72.7439670 ;
	public static final Double Perfecto_Latitude = 42.2764380 ;
	public static final Double Perfecto_Longitude = -71.7439670 ;
	public static final Double Saucelab_Latitude = 37.2764380 ;
	public static final Double Saucelab_Longitude = -121.7439670 ;
	public static final Double TestObject_Latitude = 52.57 ;
	public static final Double TestObject_Longitude = 13.395 ;
	
	public static Double PrevLatitude = 0.0;
	public static Double PrevLongitude = 0.0;
// Geofence
	...
	public static String TYPE_OF_DUCTLESS_MODE = "typeofductlessmode";
	public static String IS_SET_GEOFENCE_SLEEP_TIMER="setgeofencesleep";
	
	public static String YesterdayPeriodHeatSetpoint ="";
	public static String YesterdayPeriodCoolSetpoint ="";
	
	public static String PRIORITY_SET ="";
	public static String FANMODE_SET ="";
	
	public static String GEOFENCE_HOME_PRIORITY_SET ="geofencehomepriorityset";
	public static String GEOFENCE_HOME_FANMODE_SET ="geofencehomefanmodeset";
	public static String GEOFENCE_AWAY_PRIORITY_SET ="geofenceawaypriorityset";
	public static String GEOFENCE_AWAY_FANMODE_SET ="geofenceawayfanmodeset";
	public static String GEOFENCE_SLEEP_PRIORITY_SET ="geofencesleeppriorityset";
	public static String GEOFENCE_SLEEP_FANMODE_SET ="geofencesleepfanmodeset";
	public static String CURRENT_USERID="Current_userid";
	public static String CURRENT_PASSWORD="Current_Password";
	public static String CURRENT_LOCATION1_NAME="Current_Location";
	public static String CURRENT_LOCATION1_DEVICE1="Current_Device";
	public static String Userblocation="Userblocation";
	public static String Vacation_Setting_Page="Vacation_Setting_Pages";
